...
type Client interface {
	SymbolGet(symbol string, marketCode MarketCode) (ResponseSchema, error)
}
...
func (clt *clientImpl) SymbolGet(symbol string, marketCode MarketCode) (ResponseSchema, error) {
	...
	path := fmt.Sprintf("/symbol/%s", symbolStr)
